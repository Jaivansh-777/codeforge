...
export default function ParticipantsPanel({ participants, hostSocketId, currentSocketId }: Props) {
  return (
        ...
        {participants.map(p => {
          ...
          return (
            ...
            >
              ...
              <span className={`flex-1 font-medium ${isMe ? 'text-white/80' : 'text-white/50'}`}>
                {p.name}
